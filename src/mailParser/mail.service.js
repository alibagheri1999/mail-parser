...
function read() {
    return __awaiter(this, void 0, void 0, function () {
        var connection, box, searchCriteria, fetchOptions, results, error_1;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    results.forEach(function (res) {
                        var text = res.parts.filter(function (part) {
                            return part.which === 'TEXT';
                        });
                        var emailHTML = text[0].body;
                        var emailText = (0, html_to_text_1.convert)(emailHTML);
